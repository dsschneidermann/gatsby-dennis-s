...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, Azure Device Provisioning Service, Azure IoT Edge, ASP .NET Core, Web Services, Hangfire, C#, Azure Container Instances, Azure Resource Manager (ARM) deployment, Docker*</span>
...
As an IoT Advisor and Cloud Architect for Glaze Aps, I have worked with this in parallel to projects above and below.
...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, ASP .NET Core, C#, Microsoft Trill, Azure IoT Edge, Grafana, C# Reactive Extensions, Azure Kubernetes Service, Docker, Test Driven Development, FsCheck*</span>
...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, TimescaleDB, Azure Time Series Insights, MSSQL, Azure Data Lake and Azure Datawarehouse*</span>
...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, Azure Service Fabric, Service Fabric Actors, C#, Log Analytics, Azure Databricks, Python, R, Azure OMS, Azure Monitoring*</span>

</div>
<div class="cvProject">

### Mar 2018 - Sep 2018, Major Plant Production Company
...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, Azure DevOps CI/CD, Azure Resource Manager (ARM) deployment, Microsoft Secure Development Guidelines*</span>
...
Architect and lead developer for Azure IoT Management Platform in .NET.
...
* Key techs: <span class="highlightBlue">*Azure IoT Hub, Azure DevOps CI/CD, C#, Azure Stream Analytics, Azure CosmosDB, ASP .NET, Web Services, Azure Resource Manager (ARM) deployment, D3.js graph, Javascript*</span>
...
Architect and lead developer for IBM Cloud IoT Management Platform.
...
* Key techs: <span class="highlightBlue">*Cloudfoundry, Web Services, Python, Microsoft Flow and Logic Apps*</span>
...
* Key techs: <span class="highlightBlue">*C#, ASP .NET, Web Services, REST, OAuth, MSSQL, Entity Framework, Test Driven Development*</span>
...
* Key techs: <span class="highlightBlue">*Node.js, Gulp, Webpack, Sitecore, HTML5, CSS3*</span>
...
* Key techs: <span class="highlightBlue">*C#, ASP .NET, ElasticSearch, EpiServer, HTML5, JSON-LD*</span>
...
* Key techs: <span class="highlightBlue">*C#, VB, ASP .NET, MSSQL*</span>
...
* Key techs: <span class="highlightBlue">*C# WPF, MSSQL, Excel*</span>
...
* Key techs: <span class="highlightBlue">*C#, VB, MSSQL*</span>
